...
import 'package:rental/widgets/vehicle_details_dialog.dart'; // Importez le widget de dialogue de détails du véhicule
          ...
          Column(
            ...
            children: [
              VehicleCard(
                ...
                onTap: () {
                  // Afficher le popup de détails du véhicule
                  showDialog(
                    context: context,
